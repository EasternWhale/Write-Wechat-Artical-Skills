...
一个直接帮你生成微信公众号文章的skills    A skill that directly helps you generate WeChat Official Account articles
...
也可以手动把 skills/write-wechat-articles 整个目录复制到个人 Codex Skills 目录。
